                    ...
                    <form action="${pageContext.request.contextPath}/usuarios/insercao" method="post">
                        <table border="1">
                            ...
                            <tr>
                                ...
                                <td><input type="email" id="email" name="email" required value="${usuario.email}" />
                                </td>
                            </tr>
                            <tr>
                                <td><label for="senha">Senha:</label></td>
                                <td><input type="password" id="senha" name="senha" required value="${usuario.senha}" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="papel" name="papel" onchange="showFields()">
                                        <option value="ADMIN" ${usuario.papel=='ADMIN' ? 'selected' : '' }>ADMIN
                                        </option>
                                        <option value="CLIENTE" ${usuario.papel=='CLIENTE' ? 'selected' : '' }>CLIENTE
                                        </option>
                                        <option value="PROFISSIONAL" ${usuario.papel=='PROFISSIONAL' ? 'selected' : ''
                                            }>
                                            PROFISSIONAL</option>
                                        <option value="AMBOS" ${usuario.papel=='AMBOS' ? 'selected' : '' }>CLIENTE e
                                            PROFISSIONAL</option>
                                    </select>
                                </td>
                            </tr>
                        ...
                        <fieldset id="clienteFields" style="display:none">
                            ...
                            <table border="1">
                                <tr>
                                    ...
                                    <td><input type="text" id="telefone" name="telefone" value="${usuario.telefone}" />
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <fieldset id="profissionalFields" style="display:none">
                                ...
                                <table border="1">
                                    <tr>
                                        ...
                                        <td><input type="text" id="especialidade" name="especialidade"
                                                value="${usuario.especialidade}" /></td>
                                    </tr>
                                </table>
                        </fieldset>
                        <table border="1">
